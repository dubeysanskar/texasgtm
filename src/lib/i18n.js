...
export const RU = {
  ...
  // ── To-Do list / Daily updates ──
  'Your personal checklist, by date — write it down, check it off. Private to you — a super admin can view it, no one else.': 'Ваш личный список дел по датам — запишите и отметьте выполненное. Виден только вам — просмотреть его может ещё только супер-администратор.',
  'Viewing': 'Просмотр',
  'Me': 'Я',
  'Viewing {name}’s to-dos — read-only.': 'Просмотр списка дел: {name} — только чтение.',
  'Nothing on this list.': 'Список пуст.',
  'View their to-do list': 'Посмотреть список дел',
  'To-Do List': 'Список дел',
  'Your personal checklist, by date — write it down, check it off.': 'Ваш личный список дел по датам — запишите и отметьте выполненное.',
  'Write a to-do…': 'Введите дело…',
  'Delete this to-do?': 'Удалить это дело?',
  'Nothing on your list. Add your first to-do above.': 'Список пуст. Добавьте первое дело выше.',
  'No completed to-dos yet': 'Выполненных дел пока нет',
  ...
  'What everyone worked on today — one shared log per day, per project.': 'Чем занималась команда сегодня — общий журнал работы по дням для каждого проекта.',
  'Today\'s work': 'Работа за сегодня',
  'What did you work on? Write it here — everyone on this project will see it.': 'Чем вы занимались? Напишите здесь — все участники проекта это увидят.',
  'Attach files': 'Прикрепить файлы',
  'Post update': 'Опубликовать',
  'Posting…': 'Публикация…',
  'Nothing logged for this day yet.': 'За этот день записей пока нет.',
  'Write something or attach a file': 'Напишите что-нибудь или прикрепите файл',
  'Delete this update?': 'Удалить эту запись?',
  'Translate': 'Перевести',
  'Translating…': 'Перевод…',
  'Hide translation': 'Скрыть перевод',
  'Translation is not configured on this server': 'Перевод не настроен на сервере',
  'Translation failed': 'Не удалось перевести',
  // ── Impersonation ('view as') ──
  'Security': 'Безопасность',
  'View the portal as {name}? This is logged and visible to every super admin.': 'Просматривать портал от имени {name}? Это действие логируется и видно всем супер-администраторам.',
  'View the portal as this user': 'Просматривать портал от имени этого пользователя',
  'Viewing as {name} — every action here happens as them.': 'Вы просматриваете портал от имени {name} — все действия выполняются от его/её имени.',
  'Exit': 'Выйти',
  'Cannot view as another super admin': 'Нельзя войти от имени другого супер-администратора',
  'You\'re already logged in as yourself': 'Вы уже вошли под своей учётной записью',
  'Exit your current "view as" session first': 'Сначала завершите текущий сеанс просмотра от чужого имени',
  '"View as" audit trail': 'Журнал сеансов «от имени пользователя»',
  'Every time any super admin views the portal as another user — who, as whom, when, and for how long. Sessions auto-expire after 1 hour.': 'Каждый случай, когда супер-администратор просматривал портал от имени другого пользователя — кто, от чьего имени, когда и как долго. Сеанс автоматически завершается через 1 час.',
  'Viewed as': 'Просмотр от имени',
  'min': 'мин',
